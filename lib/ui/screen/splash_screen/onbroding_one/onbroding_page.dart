...
import 'package:event/ui/screen/splash_screen/onbroding_two/onbroding_page.dart';
import 'package:flutter/material.dart';

class OnbrodingPage extends StatelessWidget {
  const OnbrodingPage({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text("Skip",style: regularTextStyle16.copyWith(color: MyColor.whiteColor),),
                const Spacer(),
                CircleAvatar(
                  radius: 5,
                ...
                TextButton(onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const OnbrodingTwo()));
      ...
      body: Column(
        children: [
          Container(
              ...
              width: double.infinity,
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage(MyImage.spBanner1),fit: BoxFit.cover))),
